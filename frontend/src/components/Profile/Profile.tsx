...
const Profile: React.FC = () => {
  ...
  return (
    <div >
      ...
      <div className="bg-white rounded-xl shadow-md border border-gray-200 p-6 grid grid-cols-1 md:grid-cols-[30%_70%] gap-8 py-17">
        <div className="flex flex-col items-center justify-center text-center md:text-left ">
          <div className="h-24 w-24 bg-blue-100 rounded-full flex items-center justify-center shadow-md">
            <UserIcon className="h-12 w-12 text-blue-600" />
          </div>
          <h2 className="mt-3 text-2xl font-bold text-gray-900">{user?.name}</h2>
          ...
          <div className="flex flex-col gap-4 text-sm text-gray-700">
            ...
            <div className="flex items-center gap-2">
              ...
              <span>Total Income: {totalIncomes}</span>
            </div>
            <div className="flex items-center gap-2">
